...
KC_ASDF_NAME="asdf-ansible"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-ansible"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="python"
KC_ASDF_APP_NAME="ansible-community"
...
KC_ASDF_APP_REPO="https://github.com/ansible-community/ansible-build-data"
